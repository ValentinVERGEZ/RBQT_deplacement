"""autogenerated by genpy from rbqt_pathfinder/AstarPath.msg. Do not edit."""
import sys
...
class AstarPath(genpy.Message):
  _md5sum = "14ff3ce65e927005eea9f8e966ad807f"
  _type = "rbqt_pathfinder/AstarPath"
...
"""
  __slots__ = ['id','path']
  _slot_types = ['int16','nav_msgs/Path']
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_h3I.pack(_x.id, _x.path.header.seq, _x.path.header.stamp.secs, _x.path.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.id, _x.path.header.seq, _x.path.header.stamp.secs, _x.path.header.stamp.nsecs,) = _struct_h3I.unpack(str[start:end])
      start = end
      end += 4
